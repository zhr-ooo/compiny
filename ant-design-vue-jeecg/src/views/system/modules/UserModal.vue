    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="用户账号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入用户账号" v-decorator="[ 'username', validatorRules.username]" :readOnly="disableSubmit"/>
        </a-form-item>
        <a-form-item label="用户姓名" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-input placeholder="请输入用户姓名" v-decorator="[ 'realname', validatorRules.realname]" :readOnly="disableSubmit" />
        </a-form-item>

        <template v-if="!model.id">
          <a-form-item label="登陆密码" :labelCol="labelCol" :wrapperCol="wrapperCol" >
            <a-input type="password" placeholder="请输入登陆密码" v-decorator="[ 'password', validatorRules.password]" :readOnly="disableSubmit" />
          </a-form-item>
...
<!--        </a-form-item>-->
        <a-form-item label="职位" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入职务" v-decorator="[ 'avatar', validatorRules.avatar]" :readOnly="disableSubmit" />
        </a-form-item>
        <a-form-item label="手机号码" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入手机号码" v-decorator="[ 'phone', validatorRules.phone]" :readOnly="disableSubmit" />
        </a-form-item>
        <a-form-item label="座机号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入座机号" v-decorator="[ 'orgCode', validatorRules.orgCode]" :readOnly="disableSubmit" />
        </a-form-item>

        <a-form-item label="电子邮箱" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入电子邮箱" v-decorator="[ 'email', validatorRules.email]" :readOnly="disableSubmit" />
        </a-form-item>
...
<!--        </a-form-item>-->
        ...
        <a-form-item label="是否可用" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select placeholder="请选择是否可用" :disabled="disableSubmit" v-decorator="[ 'status', {}]">
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        that.$nextTick(() => {
          that.form.setFieldsValue(pick(this.model,'username','sex','realname','avatar','email','phone','activitiSync','orgCode','status'))
        });
        // 调用查询用户对应的部门信息的方法
