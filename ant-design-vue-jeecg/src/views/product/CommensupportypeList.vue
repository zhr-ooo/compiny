<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <commensupportype-modal ref="modalForm" @ok="modalFormOk"></commensupportype-modal>
  </a-card>
</template>

<script>
  import CommensupportypeModal from './modules/CommensupportypeModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "CommensupportypeList",
    mixins:[JeecgListMixin],
    components: {
      CommensupportypeModal
    },
    data () {
      return {
		...
		url: {
          list: "/product/commensupportype/list",
          delete: "/product/commensupportype/delete",
          deleteBatch: "/product/commensupportype/deleteBatch",
          exportXlsUrl: "product/commensupportype/exportXls",
          importExcelUrl: "product/commensupportype/importExcel",
       },
    }
  },
  computed: {
