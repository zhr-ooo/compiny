<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <productForward-modal ref="modalForm" @ok="modalFormOk"></productForward-modal>
  </a-card>
</template>

<script>
  import ProductForwardModal from './modules/ProductForwardModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "ProductForwardList",
    ...
    data () {
      return {
		...
		url: {
          list: "/product/productForward/list",
          delete: "/product/productForward/delete",
          deleteBatch: "/product/productForward/deleteBatch",
          exportXlsUrl: "product/productForward/exportXls",
          importExcelUrl: "product/productForward/importExcel",
       },
    }
  },
  computed: {
